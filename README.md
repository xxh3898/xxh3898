<!-- Header -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&text=Chiho%20Cho&fontSize=50&fontAlign=50&fontAlignY=35&desc=집요함과%20체계적인%20습관으로%20성장하는%20백엔드%20개발자&descAlign=50&descAlignY=60" />
</p>

## 👋 소개

> **"응답 속도를 96% 단축하는 백엔드 개발자"**  
> 단순 기능 구현을 넘어 **시스템의 병목**을 분석하고 개선하는 데 집중합니다. N+1 문제 같은 구조적 결함을 찾아내고 데이터 구조를 최적화하여 성능 문제를 근본적으로 해결합니다.

- **성능 병목 분석 및 최적화**: 다량의 단건 조회로 연쇄 발생하는 N+1 문제를 벌크 조회와 메모리 매핑 구조로 리팩토링하여 API 응답 속도를 25초에서 0.9초로 단축했습니다.
- **문서화 중심 개발 습관**: 기획서부터 트러블슈팅까지 개발 템플릿을 직접 제작하여 전 과정을 투명하게 기록하고 지식 자산으로 만듭니다.
- **구조화된 개발 프로세스**: `기획서 → API 명세 → 아키텍처` 순의 표준화된 개발 사이클을 준수하며 사후 추적을 용이하게 합니다.
- **협업 가시성 확보**: GitHub Projects 칸반보드 및 이슈/PR 템플릿 도입으로 팀원 간 작업 현황을 시각화하고 코드 리뷰 효율을 높입니다.
...
<p align="center">
  ...
  <a href="https://giddy-garment-d4d.notion.site/2d33702fcc05809b99dee56e64efff99">
